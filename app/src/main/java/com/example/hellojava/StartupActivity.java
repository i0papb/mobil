...
public class StartupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ipAddressInput.setAdapter(new ArrayAdapter<>(
                this, android.R.layout.simple_dropdown_item_1line, pastIps));
        ...
        portInput.setAdapter(new ArrayAdapter<>(
                this, android.R.layout.simple_dropdown_item_1line, portStrings));
        ...
        connectButton.setOnClickListener(v -> {
            ...
            // Download crowsnest.conf and parse camera port
            KlipperApi api = ApiClient.getApi(this);
            api.downloadFile("/etc/crowsnest/crowsnest.conf")  // adjust path if needed
